              ...
              <li <?php wc_product_class(
                ...
                <div class="relative overflow-hidden h-52">
                  <a href="<?php the_permalink(); ?>" class="block h-full">
                    ...
                    <?php else : ?>
                      <!-- IF there's no image than it will print a messgae "No Image" -->
                ...
                <div class="p-8 flex flex-col flex-grow">
                  ...
                  <!-- This tells the user the courses are self paced. -->
                  <div class="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                    <span class="text-slate-500 text-xs font-bold uppercase tracking-widest flex items-center">
                      ...
                      <!-- When the user clicks on this link, it will take them to the details of the course -->
